                    ...
                    <table id="tbl_general" name="tbl_general" class="display nowrap table table-striped table-bordered" style="width:100%">
                        ...
                        <thead class="text-center">
                            ...
                            <tr>
                                ...
                                <th style="text-transform: capitalize;"><i class="bi bi-person-rolodex"></i> Codigo de tipo de cliente </th>
                                <th style="text-transform: capitalize;"><i class="bi bi-input-cursor-text"></i> Nombre de tipo cliente </th>

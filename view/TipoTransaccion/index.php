            ...
            <div class="container-fluid">
                <header class="section-header">
                    <div class="tbl">
                        <div class="tbl-row">
                            <div class="tbl-cell">
                                <h3>Mantenimiento tipo de transacción</h3>
                                <ol class="breadcrumb breadcrumb-simple">
                                    <li><a href="../Home/">Home</a></li>
                                    <li class="active">Mantenimiento tipo de transacción</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="box-typical box-typical-padding">
                    ...
                    <table id="tbl_general" name="tbl_general" class="display nowrap table table-striped table-bordered" style="width:100%">
                        ...
                        <thead class="text-center">
                            ...
                            <tr>
                                <th>#</th>
                                <th><i class="bi bi-person-rolodex"></i> Código de tipo de movimiento </th>
                                <th><i class="bi bi-person-rolodex"></i> Código de tipo de transacción </th>
                                <th><i class="bi bi-input-cursor-text"></i> Nombre de tipo transacción </th>

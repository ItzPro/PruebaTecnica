            ...
            <div class="container-fluid">
                <header class="section-header">
                    <div class="tbl">
                        <div class="tbl-row">
                            <div class="tbl-cell">
                                <h3>Mantenimiento Tipo De Transaccion</h3>
                                <ol class="breadcrumb breadcrumb-simple">
                                    <li><a href="../Home/">Home</a></li>
                                    <li class="active">Mantenimiento Tipo De Transaccion</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="tbl_general" name="tbl_general" class="display nowrap table table-striped table-bordered" style="width:100%">
                        ...
                        <thead class="text-center">
                            ...
                            <tr>
                                ...
                                <th style="text-transform: capitalize;"><i class="bi bi-person-rolodex"></i> Codigo de tipo de Movimiento </th>
                                <th style="text-transform: capitalize;"><i class="bi bi-person-rolodex"></i> Codigo de tipo de Transaccion </th>
                                <th style="text-transform: capitalize;"><i class="bi bi-input-cursor-text"></i> Nombre de tipo Transaccion </th>
